...
-- Update the profiles table RLS policy to allow reading organization data
-- (This assumes profiles table already has RLS enabled)
...
-- Verify the setup
SELECT 
    'BeyondIt Organization Created' as status,
...
SELECT 
    ...
    COUNT(*) as profiles_with_organization
FROM profiles 
WHERE organization_id = '00000000-0000-0000-0000-000000000001';
